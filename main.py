...
def get_parser():
    ...
    parser.add_argument(
        '--config',
        default='./config/st_gcn/hanchoom/train.yaml',
    ...
    # feeder
    parser.add_argument(
        '--feeder', default='feeder.feeder_hanchoom', help='data loader will be used')
    parser.add_argument(
        '--num-worker',
        type=int,
        default=128,
...
if __name__ == '__main__':
    ...
    # EVALUATE:  python main.py --config config/st_gcn/hanchoom/test.yaml
    # TRAIN:  python main.py --config config/st_gcn/hanchoom/train.yaml [--work-dir <work folder>]
